...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=ILAYDA\\SQLEXPRESS; Database=FurnApp;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cart>(entity =>
            {
                ...
                entity.HasOne(d => d.Products)
                    ...
                    .HasConstraintName("FK__Cart__Products_I__4CA06362");

                entity.HasOne(d => d.Users)
                    .WithMany(p => p.Cart)
                    .HasForeignKey(d => d.UsersId)
                    .HasConstraintName("FK__Cart__Users_Id__4BAC3F29");
            });

            modelBuilder.Entity<Categories>(entity =>
            {
                entity.HasKey(e => e.CategoryId)
                    .HasName("PK__Categori__6DB38D6E7D4D6A01");
            ...
            modelBuilder.Entity<Colors>(entity =>
            {
                entity.HasKey(e => e.ColorId)
                    .HasName("PK__Colors__795F1D546B02CFE0");
            ...
            modelBuilder.Entity<Orders>(entity =>
            {
                entity.HasKey(e => e.OrderId)
                    .HasName("PK__Orders__F1E4607B57CD2FCB");
                ...
                entity.HasOne(d => d.Address)
                    ...
                    .HasConstraintName("FK__Orders__Address___5165187F");
            ...
            modelBuilder.Entity<Payment>(entity =>
            {
                ...
                entity.HasOne(d => d.Users)
                    ...
                    .HasForeignKey(d => d.UsersId)
                    .HasConstraintName("FK__Payment__Users_I__48CFD27E");
            });

            modelBuilder.Entity<ProductColors>(entity =>
            {
                entity.HasKey(e => new { e.ProductId, e.ColorId })
                    .HasName("PK__Product___CFA10A6F27E94438");
                ...
                entity.HasOne(d => d.Color)
                    ...
                    .HasConstraintName("FK__Product_C__Color__5535A963");
            ...
            modelBuilder.Entity<Products>(entity =>
            {
                entity.HasKey(e => e.ProductId)
                    .HasName("PK__Products__9834FBBAE626533E");
